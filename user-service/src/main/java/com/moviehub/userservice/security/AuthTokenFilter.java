...
import com.moviehub.userservice.service.MyUserDetailsService;
...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    public AuthTokenFilter(MyUserDetailsService personDetailsService, JwtUtils jwtUtils) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            MyUserDetails personDetails = personDetailsService.loadUserByUsername(username);
