package com.moviehub.watchlistservice.event;
...
public final class EventServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<EventRequest,
      com.moviehub.watchlistservice.event.EventResponse> getLogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "log",
      requestType = EventRequest.class,
      responseType = com.moviehub.watchlistservice.event.EventResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<EventRequest,
      com.moviehub.watchlistservice.event.EventResponse> getLogMethod() {
    io.grpc.MethodDescriptor<EventRequest, com.moviehub.watchlistservice.event.EventResponse> getLogMethod;
      ...
      synchronized (EventServiceGrpc.class) {
        if ((getLogMethod = EventServiceGrpc.getLogMethod) == null) {
          EventServiceGrpc.getLogMethod = getLogMethod =
              io.grpc.MethodDescriptor.<EventRequest, com.moviehub.watchlistservice.event.EventResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.moviehub.watchlistservice.event.EventResponse.getDefaultInstance()))
  ...
  public static abstract class EventServiceImplBase implements io.grpc.BindableService {
    ...
    public void log(EventRequest request,
                    io.grpc.stub.StreamObserver<com.moviehub.watchlistservice.event.EventResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                EventRequest,
                com.moviehub.watchlistservice.event.EventResponse>(
                  this, METHODID_LOG)))
          .build();
    }
  }
  ...
  public static final class EventServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EventServiceBlockingStub> {
    ...
    /**
     */
    public com.moviehub.watchlistservice.event.EventResponse log(EventRequest request) {
  ...
  public static final class EventServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EventServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.moviehub.watchlistservice.event.EventResponse> log(
  ...
  private static abstract class EventServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.moviehub.watchlistservice.event.EventServiceOuterClass.getDescriptor();
    }
